...
describe('AuthService', () => {
  ...
  it('should throw error in production if JWT_SECRET is missing', async () => {
    ...
    ).rejects.toThrow('CRITICAL SECURITY ERROR: JWT_SECRET is not defined');
  });
