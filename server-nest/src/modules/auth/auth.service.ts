...
export class AuthService {
  ...
  async login(loginDto: LoginDto) {
    ...
    // ⚡ Bolt Optimization: Use queryRaw for case-insensitive lookup to avoid fetching ALL staff
    ...
    // Map raw SQLite result types (0/1 for boolean)
    const user = {
      ...rawUser,
      online: Boolean(rawUser.online),
    };
  ...
  async register(registerDto: RegisterDto) {
    ...
    // ⚡ Bolt Optimization: Check for existing user efficiently
